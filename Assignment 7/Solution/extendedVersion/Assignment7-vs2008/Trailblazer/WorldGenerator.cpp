 ...
 */
Grid<double> generateRandomMazeKruskal(int numRows, int numCols) {
  Set<Edge> maze = createMaze(numRows, numCols);
  return wallsToGrid(maze, numRows, numCols);
}
Grid<double> generateRandomMazePrim(int numRows, int numCols) {
Set<Edge> maze = createMazePrim(numRows, numCols);
  return wallsToGrid(maze, numRows, numCols);
}
